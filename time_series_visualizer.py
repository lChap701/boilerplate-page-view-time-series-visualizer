...
def draw_line_plot():
    """
    Draws a line plot using the dataset

    Returns:
        Figure: Returns the line plot that was created
    """
...
def draw_bar_plot():
    """
    Draws a bar plot using the dataset

    Returns:
        Figure: Returns the bar plot that was created
    """
    ...
    chart = sns.barplot(data=df_bar, x="Years",
                        y="Average Page Views", hue="Months")
...
def draw_box_plot():
    """
    Draws a box plot using the dataset

    Returns:
        Figure: Returns the box plot that was created
    """
    ...
    # Sets up the box plot (using Seaborn)
